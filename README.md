...
**Signing in is free and takes one GitHub click** — it moves you from 50 calls a day to 200, on a stable account that does not rotate with your IP. Point the server at `https://gateway.pipeworx.io/oauth/mcp` and complete the sign-in when prompted, or [sign up first](https://pipeworx.io/signup?via=cursor_plugin).
