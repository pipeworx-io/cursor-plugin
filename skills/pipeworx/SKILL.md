...
Pipeworx is a live data gateway. You have ~26 meta-tools loaded into context; the underlying catalog of **5,000+ tools across 1,300+ sources** is reachable on demand via `ask_pipeworx` and `discover_tools` — no need to load every definition upfront. This skill exists to make sure you reach for the right meta-tool.
